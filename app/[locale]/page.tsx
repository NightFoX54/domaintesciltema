...
export default function HomePage() {
  ...
  const getLocalizedPath = (path: string) => addLocaleToPath(path, locale as 'en' | 'tr')
    ...
    <div className="min-h-screen bg-background">
      ...
      <HeroSection
        ...
        searchInput={{
          ...
          searchHref: getLocalizedPath("/configure/domain?domain=yourdomain.com&tld=.com"),
        }}
        additionalContent={
      ...
      <SectionWrapper padding="lg">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <ProductCard
            ...
            actionHref={getLocalizedPath("/domains")}
          />
          <ProductCard
            ...
            actionHref={getLocalizedPath("/hosting")}
          />
          <ProductCard
            ...
            actionHref={getLocalizedPath("/ssl")}
          />
        </div>
      </SectionWrapper>
            ...
            <CardContent>
              ...
              <div className="pt-3 space-y-3 border-t border-border/50">
                ...
                <Button variant="outline" className="w-full bg-transparent hover:bg-foreground/5 mt-4" asChild>
                  <Link href={getLocalizedPath("/hosting")}>{t("outcomes.simpleWebsite.action")}</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-border rounded-xl p-8 space-y-5 hover:border-foreground/30 hover:shadow-sm transition-all">
            <CardContent>
              ...
              <div className="pt-3 space-y-3 border-t border-border/50">
                ...
                <Button variant="outline" className="w-full bg-transparent hover:bg-foreground/5 mt-4" asChild>
                  <Link href={getLocalizedPath("/hosting")}>{t("outcomes.sellOnline.action")}</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-border rounded-xl p-8 space-y-5 hover:border-foreground/30 hover:shadow-sm transition-all">
            <CardContent>
              ...
              <div className="pt-3 space-y-3 border-t border-border/50">
                ...
                <Button variant="outline" className="w-full bg-transparent hover:bg-foreground/5 mt-4" asChild>
                  <Link href={getLocalizedPath("/hosting")}>{t("outcomes.professional.action")}</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-border rounded-xl p-8 space-y-5 hover:border-foreground/30 hover:shadow-sm transition-all">
            <CardContent>
              ...
              <div className="pt-3 space-y-3 border-t border-border/50">
                ...
                <Button variant="outline" className="w-full bg-transparent hover:bg-foreground/5 mt-4" asChild>
                  <Link href={getLocalizedPath("/contact")}>{t("outcomes.custom.action")}</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-border rounded-xl p-8 space-y-5 hover:border-foreground/30 hover:shadow-sm transition-all">
            <CardContent>
              ...
              <div className="pt-3 space-y-3 border-t border-border/50">
                ...
                <Button variant="outline" className="w-full bg-transparent hover:bg-foreground/5 mt-4" asChild>
                  <Link href={getLocalizedPath("/contact")}>{t("outcomes.unsure.action")}</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-border rounded-xl p-8 space-y-5 hover:border-foreground/30 hover:shadow-sm transition-all">
            <CardContent>
              ...
              <div className="pt-3 space-y-3 border-t border-border/50">
                ...
                <Button variant="outline" className="w-full bg-transparent hover:bg-foreground/5 mt-4" asChild>
                  <Link href={getLocalizedPath("/migration")}>{t("outcomes.migration.action")}</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
      ...
      <CTABlock
        ...
        primaryAction={{
          label: t("cta.primary"),
          href: getLocalizedPath("/domains/search"),
        }}
        secondaryAction={{
